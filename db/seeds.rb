ingredinets = [
	...
	{
		"uuid": "2EEOBTx9yb8n",
		"name": "Strawberries Jam",
		"category": "Sweets & Spirits",
		"index": 390
	},
	{
		"uuid": "3ApH4WxcVBgg",
		"name": "Raspberries Jam",
		"category": "Sweets & Spirits",
		"index": 391
	},
	{
...
ingredinets.each do |ing|
	# byebug
	e = Ingredient.new
	e.name = ing[:name]
	e.uuid = ing[:uuid]
	e.index = ing[:index]
	e.category = ing[:category]
	e.save
end